...
import com.capitalone.dashboard.auth.sso.SsoAuthenticationService;
...
@ComponentScan(basePackages = {"com.capitalone.dashboard.settings","com.capitalone.dashboard.auth.*"})
...
//    }
    ...
    protected SsoAuthenticationFilter ssoAuthenticationFilter() throws Exception {
        return new SsoAuthenticationFilter("/findUser", authenticationManager(), authenticationResultHandler, ssoAuthenticationService);
    }
