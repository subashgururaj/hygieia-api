...
public class DashboardController {
    ...
    private final PaginationHeaderUtility paginationHeaderUtility;
    ...
    public List<Dashboard> getOwnedDashboards() {
        return dashboardService.getOwnedDashboards();
    ...
    public ResponseEntity<String> updateScoreSettings(
      ...
      @RequestParam(value = "scoreEnabled", defaultValue = "false") boolean scoreEnabled,
