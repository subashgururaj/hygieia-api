...
public class GithubWebHookRequestFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected static boolean checkForEmptyValues(String userAgent, String githubEnterpriseHost, String userAgentExpectedValue,
                                                 List<String> githubEnterpriseHostExpectedValues) {
        boolean result = false;

        if (checkForEmptyStringValues(new String[]{userAgent, githubEnterpriseHost, userAgentExpectedValue})
