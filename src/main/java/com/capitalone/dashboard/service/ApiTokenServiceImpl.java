...
public class ApiTokenServiceImpl implements ApiTokenService {
    ...
    private static boolean isUserAdmin(UserInfo user) {
    ...
    public void deleteToken(ObjectId id) {
        ...
        if(apiToken == null) {
            throw new UnsafeDeleteException("Cannot delete token " + id);
        }else{
    ...
    public String updateToken(Long expirationDt, ObjectId id) throws HygieiaException{
        ApiToken apiToken = apiTokenRepository.findOne(id);
        if(apiToken == null) {
            throw new HygieiaException("Cannot find token for " + id, HygieiaException.BAD_DATA);
        }else{
