...
public class UserInfoServiceImpl implements UserInfoService {
	...
	private static UserInfo createUserInfo(String username, String firstName, String middleName, String lastName, String displayName, String emailAddress, AuthType authType) {
	...
	private static void addAdminRoleToStandardAdminUser(UserInfo userInfo) {
	...
	private static Collection<? extends GrantedAuthority> createAuthorities(Collection<UserRole> authorities) {
