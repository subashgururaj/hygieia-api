...
public class FeatureServiceImpl implements FeatureService {
	...
	public DataResponse<List<Feature>> getFeatureEpicEstimates(ObjectId componentId, String teamId, String projectId,
		...
		if (isEstimateTime(estimateMetricType)) {
			...
			epicIDToEpicFeatureMap.values().forEach(f -> f.setsEstimate(String.valueOf(Integer.valueOf(f.getsEstimate()) / 60)));
		}
	...
	private static boolean isEstimateCount(Optional<String> estimateMetricType) {
