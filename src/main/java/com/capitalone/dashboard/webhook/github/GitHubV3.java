...
public abstract class GitHubV3 {
    ...
    private static final Pattern COMPILE_REPLACE = Pattern.compile("_", Pattern.LITERAL);
    ...
    private static boolean checkForEmptyStringValues(String[] values) {
    ...
    protected String getLDAPDN(String repoUrl, String user, String token) {
        ...
        String formattedUser = COMPILE_REPLACE.matcher(user).replaceAll(Matcher.quoteReplacement("-"));
        String ldapLdn = null;
        try {
    ...
    protected void checkForErrors(JSONObject responseJsonObject) throws HygieiaException {
