...
//            .thenReturn(Optional.of(collector));
        ...
        when(collectorItemRepository.findByOptionsAndDeployedApplicationName(any(), anyString()))
                .thenReturn(Collections.singletonList(item));
        when(collectorRepository
                .findOne(item.getCollectorId())).thenReturn(collector);
