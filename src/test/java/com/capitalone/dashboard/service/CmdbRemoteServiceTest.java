...
//        when(cmdbRepository.findByConfigurationItemAndItemType("","" )).thenReturn(null);
        when(collectorService.createCollectorItem(any(CollectorItem.class) )).thenReturn(makeCollectorItem());
        ...
        when(cmdbRepository.save(any(Cmdb.class))).thenReturn(expected);
