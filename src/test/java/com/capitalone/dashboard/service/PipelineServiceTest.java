...
public class PipelineServiceTest {
    ...
    private Dashboard makeTeamDashboard(String template, String title, String appName, String owner, String configItemAppName,String configItemComponentName, String... compNames) {
        ...
        return new Dashboard(template, title, app, new Owner(owner, AuthType.STANDARD), DashboardType.Team, configItemAppName, configItemComponentName, activeWidgets, false, ScoreDisplayType.HEADER);
    }
    ...
    private PipelineResponse makePipelineResponse(Pipeline pipeline, Dashboard dashboard){
        ...
        pipelineStageList.forEach(stage -> pipelineResponse.setStageCommits(stage, new ArrayList<>()));
