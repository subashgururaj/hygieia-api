...
public class BuildServiceTest {
    ...
    public void search() {
        ...
        verify(buildRepository, times(1)).findAll(any(Predicate.class));
    }
...
//        when(dashboardService.getDashboardsByCollectorItems(any(Set.class), any(CollectorType.class))).thenReturn(dashboards);
    ...
    private class PredicateMatcher implements ArgumentMatcher<String> {

        private String left;

         PredicateMatcher(String left) {
            this.left = left;
        }
