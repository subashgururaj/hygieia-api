...
public class GitHubPullRequestV3Test {
    ...
    public void buildGraphQLQueryTest_ALL() {
        ...
        assert gitHubParsed != null;
        assert variableJSONObject != null;
    ...
    public void buildGitRequestFromPayloadTest() {
        ...
        when(gitHubPullRequestV3.buildCollectorItem(any(), any(), any())).thenReturn(collectorItem);
    ...
    public void getPRCommitsTest() {
        GitHubPullRequestV3 gitHubPullRequestV3 = Mockito.spy(this.gitHubPullRequestV3);
        when(gitHubPullRequestV3.getLDAPDN(any(), any(), any())).thenReturn("authorLDAPDN");
    ...
    public void setCollectorItemIdExistingPullRequestTest() throws MalformedURLException, HygieiaException {
        ...
        when(gitRequestRepository.findByScmUrlIgnoreCaseAndScmBranchIgnoreCaseAndNumberAndRequestTypeIgnoreCase(any(), any(), any(), any())).thenReturn(existingPullRequest);
