...
public class CodeQualityControllerTest {
	...
	public void staticQualities() throws Exception {
		...
		when(codeQualityService.search(ArgumentMatchers.any(CodeQualityRequest.class)))
				.thenReturn(response);
		mockMvc.perform(
    ...
    public void insertStaticAnalysisTest1() throws Exception {
        ...
        when(codeQualityService.create(ArgumentMatchers.any(CodeQualityCreateRequest.class))).thenReturn("123456");
	...
	public void insertStaticAnalysisTest1_v2() throws Exception {
		...
		@SuppressWarnings("unused")
		byte[] content = TestUtil.convertObjectToJsonBytes(request);
		when(codeQualityService.createV2(ArgumentMatchers.any(CodeQualityCreateRequest.class))).thenReturn("123456");
    ...
    public void insertStaticAnalysisTest2() throws Exception {
        ...
        @SuppressWarnings("unused")
		byte[] content = TestUtil.convertObjectToJsonBytes(request);
        when(codeQualityService.create(ArgumentMatchers.any(CodeQualityCreateRequest.class))).thenReturn("1234");
        mockMvc.perform(post("/quality/static-analysis")
                .contentType(TestUtil.APPLICATION_JSON_UTF8)
                .content(TestUtil.convertObjectToJsonBytes(request)))
	...
	public void insertStaticAnalysisTest2_v2() throws Exception {
		...
		@SuppressWarnings("unused")
		byte[] content = TestUtil.convertObjectToJsonBytes(request);
		when(codeQualityService.createV2(ArgumentMatchers.any(CodeQualityCreateRequest.class))).thenReturn("1234");
    ...
    public void insertStaticAnalysisTest3() throws Exception {
        ...
        @SuppressWarnings("unused")
		byte[] content = TestUtil.convertObjectToJsonBytes(request);
        when(codeQualityService.create(ArgumentMatchers.any(CodeQualityCreateRequest.class))).thenThrow(new HygieiaException("This is bad", HygieiaException.COLLECTOR_CREATE_ERROR));
        mockMvc.perform(post("/quality/static-analysis")
                .contentType(TestUtil.APPLICATION_JSON_UTF8)
                .content(TestUtil.convertObjectToJsonBytes(request)))
	...
	public void insertStaticAnalysisTest3_v2() throws Exception {
		...
		@SuppressWarnings("unused")
		byte[] content = TestUtil.convertObjectToJsonBytes(request);
		when(codeQualityService.createV2(ArgumentMatchers.any(CodeQualityCreateRequest.class))).thenThrow(new HygieiaException("This is bad", HygieiaException.COLLECTOR_CREATE_ERROR));
		mockMvc.perform(post("/v2/quality/static-analysis")
				.contentType(TestUtil.APPLICATION_JSON_UTF8)
				.content(TestUtil.convertObjectToJsonBytes(request)))
				.andExpect(status().isInternalServerError());
