...
public class ZCommitControllerTest {
    ...
    public void commit_search() throws Exception {
        ...
        when(commitService.search(ArgumentMatchers.any(CommitRequest.class))).thenReturn(response);
    ...
    public void insertCommitGoodRequest() throws Exception {
        ...
        when(commitService.createFromGitHubv3(ArgumentMatchers.any(JSONObject.class))).thenReturn("123456");
    ...
    public void insertCommitBadRequest1() throws Exception {
        ...
        when(commitService.createFromGitHubv3(ArgumentMatchers.any(JSONObject.class))).thenReturn("");
        mockMvc.perform(post("/commit/github/v3")
                .contentType(TestUtil.APPLICATION_JSON_UTF8)
                .content(content))
