...
public class BuildControllerTest {
    ...
    public void builds() throws Exception {
        ...
        when(buildService.search(ArgumentMatchers.any(BuildSearchRequest.class))).thenReturn(response);
    ...
    public void insertBuildGoodRequest() throws Exception {
        ...
        when(buildService.create(ArgumentMatchers.any(BuildDataCreateRequest.class))).thenReturn("123456");
...
//        @SuppressWarnings("unused")
        byte[] content = TestUtil.convertObjectToJsonBytes(request);
        when(buildService.createV2(ArgumentMatchers.any(BuildDataCreateRequest.class))).thenReturn("123456");
