...
public class BinaryArtifactControllerTest {
    ...
    public void insertArtifactGoodRequest() throws Exception {
        ...
        when(artifactService.create(ArgumentMatchers.any(BinaryArtifactCreateRequest.class))).thenReturn("1234");
    ...
    public void insertBuildBadRequest1() throws Exception {
        ...
        when(artifactService.create(ArgumentMatchers.any(BinaryArtifactCreateRequest.class))).thenReturn("");
                mockMvc.perform(post("/artifact")
                        .contentType(TestUtil.APPLICATION_JSON_UTF8)
                        .content(TestUtil.convertObjectToJsonBytes(request)))
