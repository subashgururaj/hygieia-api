...
public class ConfigurationControllerTest {
	...
	public void insertConfigurationTest() throws Exception {
		...
		when(configurationService.insertConfigurationData((List<Configuration>) ArgumentMatchers.any(ConfigurationCreateRequest.class))).thenReturn((config));
	...
	private static List<Configuration> makeConfiguration() {
