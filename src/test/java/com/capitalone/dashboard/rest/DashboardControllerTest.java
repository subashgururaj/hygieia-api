...
public class DashboardControllerTest {
    ...
    public void updateTeamDashboard() throws Exception {
        ...
        when(dashboardService.update(ArgumentMatchers.any(Dashboard.class))).thenReturn(orig);
        initiateSecurityContext("amit", AuthType.STANDARD);
    ...
    public void addWidget() throws Exception {
        ...
        when(dashboardService.addWidget(ArgumentMatchers.any(Dashboard.class), ArgumentMatchers.any(Widget.class))).thenReturn(widgetWithId);
    ...
    public void updateWidget() throws Exception {
        ...
        when(dashboardService.updateWidget(ArgumentMatchers.any(Dashboard.class), ArgumentMatchers.any(Widget.class))).thenReturn(widget);
    ...
    public void deleteWidget() throws Exception {
        ...
        when(dashboardService.get(dashId)).thenReturn(d1);
        when(dashboardService.getWidget(d1, widgetId)).thenReturn(widget);
        dashboardService.deleteWidget(ArgumentMatchers.any(Dashboard.class), ArgumentMatchers.any(Widget.class), ArgumentMatchers.any(ObjectId.class));
