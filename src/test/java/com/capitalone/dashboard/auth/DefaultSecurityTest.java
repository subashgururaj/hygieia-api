...
@SpringBootTest(classes = {TestDefaultAuthConfig.class, WebMVCConfig.class, WebSecurityConfig.class})
@WebAppConfiguration
...
public class DefaultSecurityTest {
    ...
    public void adminUser_deleteDashboard() throws Exception {
        String jwtHeader = authenticateAs("someAdmin", "someAdminPassword", new UserRole[]{UserRole.ROLE_ADMIN, UserRole.ROLE_USER});
    ...
    public void owner_deleteDashboard() throws Exception {
        String jwtHeader = authenticateAs("someUser", "someUserPassword", new UserRole[]{UserRole.ROLE_USER});
    ...
    private String authenticateAs(String username, String password, UserRole[] roles) throws Exception {
        ...
        return loginResult.getResponse().getHeader(Objects.requireNonNull(ReflectionTestUtils.getField(TokenAuthenticationServiceImpl.class, "AUTH_RESPONSE_HEADER")).toString());
    }
}
